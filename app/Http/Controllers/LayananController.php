...
class LayananController extends Controller
{
    ...
    public function store(Request $request)
    {
        try{
            ...
            $validated = $request->validate([
                ...
                'foto_layanan' => 'required|image|mimes:jpg,jpeg,png|max:2048',
            ]);
            ...
            // Simpan foto
            $fotoPath = $request->file('foto_layanan')->store('layanan', 'public');
    ...
    public function update(Request $request, string $id_layanan)
    {
        ...
        try{
            ...
            $layanan = Layanan::where('id_layanan', $id_layanan)->firstOrFail();
