...
class PelangganController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $jumlahSemua = Peanggan::count();
        $jumlahAdmin = Peanggan::where('role', 'admin')->count();
        $jumlahKasir = Peanggan::where('role', 'kasir')->count();
        $jumlahPetugas = Peanggan::where('role', 'petugas')->count();
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->back()->with('success', 'Pelanggan telah ditambahkan!');
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
