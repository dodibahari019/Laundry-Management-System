            ...
            <div class="fade-in">
                <div class="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-100">
                    ...
                    <form id="formLogin" class="space-y-6">
                        ...
                        <a
                            href="/login"
                            class="w-full bg-white-100 text-white-700 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-200 transition shadow-lg flex items-center justify-center gap-3"
                        >
