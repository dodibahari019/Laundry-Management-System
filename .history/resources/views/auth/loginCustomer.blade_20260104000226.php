                    ...
                    <form id="formLogin" class="space-y-6">
                        ...
                        >
                         ...
                         <!-- Login as Employee -->
                            <a
                                href="/login"
                                class="bg-purple-100 text-purple-700 px-4 py-3 rounded-xl font-semibold text-sm hover:bg-purple-200 transition shadow-md hover-scale flex items-center justify-center gap-2"
                            >
