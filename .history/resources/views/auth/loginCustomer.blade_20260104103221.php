                    ...
                    <form id="formLogin" class="space-y-6">
                        ...
                        <div class="text-center mt-6">
                            <p class="text-gray-600">
                                Belum punya akun? 
                                <a href="/register" class="font-bold text-purple-600 hover:text-purple-800 transition">
                                    Daftar Sekarang
                                </a>
                            </p>
                        </div>
                        ...
                        <a
                            href="/login"
                            class="w-full bg-white-100 border-2 border-gray-300 text-white-700 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-200 transition shadow-lg flex items-center justify-center gap-3"
                        >
