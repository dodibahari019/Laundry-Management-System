...
<head>
    ...
    <title>D`Laundry | Customer Login</title>
    <!-- Favicon -->
        ...
        <div class="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div class="hidden md:block fade-in">
                <div class="text-center mb-10">
                    ...
                    <p class="text-xl text-gray-600 mt-4">Layanan Laundry Terpercaya</p>
                    <p class="text-gray-500 mt-2">Bersih, Cepat, dan Profesional</p>
                </div>
            </div>
