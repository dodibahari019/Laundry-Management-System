        ...
        <div class="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div class="hidden md:block fade-in">
                <div class="text-center mb-10">
                    ...
                    <p class="text-xl text-gray-600 mt-4">Bergabunglah dengan Kami</p>
                    <p class="text-gray-500 mt-2">Nikmati layanan laundry terbaik</p>
                    ...
                    <div class="mt-8 space-y-4">
                        <div class="flex items-center justify-center space-x-3">
                            ...
                            <span class="text-gray-700 font-medium">Pelayanan Cepat & Berkualitas</span>
                        </div>
                        <div class="flex items-center justify-center space-x-3">
                            <div class="w-12 h-12 gradient-primary rounded-full flex items-center justify-center">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex items-center justify-center space-x-3">
                            ...
                            <span class="text-gray-700 font-medium">Antar-Jemput Gratis</span>
                        </div>
                    </div>
                </div>
            </div>
