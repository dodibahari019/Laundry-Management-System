...
<div class="bg-white rounded-2xl p-6 mb-6 border border-gray-100">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
        ...
        <div class="md:col-span-2">
            ...
            <div class="relative">
                <input type="text" placeholder="Cari nama, no hp, alamat..." class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
        ...
        <div class="flex items-end">
            <button data-url="/pelanggan/create"
                class="modal-crud w-full px-4 py-3 gradient-primary text-white rounded-xl font-semibold hover:shadow-lg transition flex items-center justify-center space-x-2">
