...
<div class="bg-white rounded-2xl p-6 mb-6 border border-gray-100">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
        ...
        <div class="md:col-span-2">
            ...
            <div class="relative">
                <input type="text" id="searchPelanggan" name="search" form="formFilter" value="{{ $search }}"
                    placeholder="Cari nama, no hp, alamat..." class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl text-sm
        ...
        <div>
            ...
            <select name="sort" id="sortSelect" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm">
...
<div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
    <div class="p-6 border-b border-gray-200 flex items-center justify-between">
        <div>
            ...
            @if(session('success'))
            <div class="mt-4 p-4 bg-green-100 border border-green-300 text-green-800 rounded-xl shadow">
                {{ session('success') }}
            </div>
            @endif
        </div>
