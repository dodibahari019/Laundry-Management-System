<aside id="sidebar" class="sidebar bg-gray-900 text-gray-300 w-64 flex-shrink-0 overflow-y-auto no-scrollbar flex flex-col h-screen">
    <div class="p-6">
        <!-- Logo -->
        ...
        <nav class="space-y-2 flex-1">
            ...
            <!-- User Management -->
            <a href="/users" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
