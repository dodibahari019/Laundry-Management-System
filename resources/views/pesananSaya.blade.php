        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12 fade-in">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ url('/order') }}" class="hidden md:inline-flex items-center gap-2 gradient-primary text-white px-6 py-3 rounded-2xl font-bold hover:opacity-90 transition shadow-lg">
