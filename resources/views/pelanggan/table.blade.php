        ...
        <tr class="hover:bg-gray-50 transition">
            ...
            <td class="py-4 px-6">
                <div class="flex items-center justify-center space-x-2">
                    ...
                    <form id="deleteFormPelanggan{{ $p->id_pelanggan }}" action="/pelanggan/{{ $p->id_pelanggan }}" method="POST" style="display:none;">
                        @csrf
                        @method('DELETE')
                    </form>
                    <button onclick="confirmDeletePelanggan('{{ $p->id_pelanggan }}', this)" class="text-red-600 hover:text-red-800 p-1" title="Hapus">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
