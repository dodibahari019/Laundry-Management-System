...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-10">
                    ...
                    <a href="#keunggulan"
                        class="text-gray-700 hover:text-purple-600 font-medium transition">Keunggulan</a>
                    <a href="#testimoni"
                        class="text-gray-700 hover:text-purple-600 font-medium transition">Testimoni</a>
                ...
                <a href="/customer-login"
                    class="gradient-primary text-white px-7 py-2.5 rounded-xl font-semibold hover:opacity-90 transition shadow-lg">
                    Login
                </a>
            </div>
        </div>
    ...
    <section id="beranda" class="pt-32 pb-24 gradient-primary relative overflow-hidden">
            ...
            <div class="grid md:grid-cols-2 gap-16 items-center">
                <div class="text-white fade-in">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="#layanan"
                            class="bg-white text-black px-10 py-4 rounded-xl font-bold text-lg hover:bg-purple-50 transition shadow-2xl text-center">
                            Lihat Layanan
                        </a>
                        <a href="#tracking"
                            class="bg-white text-black px-10 py-4 rounded-xl font-bold text-lg hover:bg-purple-50 transition shadow-2xl text-center">
        ...
        <div class="absolute bottom-0 left-0 w-full">
            <svg viewBox="0 0 1440 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M0 100L60 88.3C120 76.7 240 53.3 360 40C480 26.7 600 23.3 720 30C840 36.7 960 53.3 1080 60C1200 66.7 1320 63.3 1380 61.7L1440 60V100H1380C1320 100 1200 100 1080 100C960 100 840 100 720 100C600 100 480 100 360 100C240 100 120 100 60 100H0Z"
                    fill="#F9FAFB" />
            </svg>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-3xl p-10 hover-scale shadow-lg border border-gray-100">
                    ...
                    <div class="gradient-text text-2xl font-bold">Rp 8.000<span class="text-gray-500 text-lg">/kg</span>
                    </div>
                ...
                <div class="bg-white rounded-3xl p-10 hover-scale shadow-lg border-2 border-purple-200">
                    ...
                    <div class="flex items-center gap-2 mb-3">
                        ...
                        <span
                            class="bg-purple-100 text-purple-700 px-3 py-1 rounded-full text-xs font-bold">POPULER</span>
                    </div>
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        Layanan kilat untuk kebutuhan mendesak. Proses cepat tanpa mengurangi kualitas hasil.
                    </p>
                    <div class="gradient-text text-2xl font-bold">Rp 15.000<span
                            class="text-gray-500 text-lg">/kg</span></div>
                ...
                <div class="bg-white rounded-3xl p-10 hover-scale shadow-lg border border-gray-100">
                    ...
                    <div class="gradient-text text-2xl font-bold">Rp 25.000<span
                            class="text-gray-500 text-lg">/pcs</span></div>
            ...
            <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                ...
                <div class="bg-white rounded-3xl p-10 border-0 border-purple-200 hover-scale">
                    ...
                    <div class="space-y-5 mb-8">
                        ...
                        <div
                            class="flex justify-between items-center p-4 bg-white-100 border-1 border-purple-300 rounded-xl">
                            <span class="text-gray-700 font-medium">{{ $kiloan->nama_layanan }}</span>
                            <span class="text-xl font-bold gradient-text">Rp
                                {{number_format($kiloan->harga, 0, ',', '.')}}/kg</span>
                        </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="bg-white rounded-3xl p-10 border-0 border-orange-200 hover-scale">
                    ...
                    <div class="space-y-5 mb-8">
                        ...
                        <div
                            class="flex justify-between items-center p-4 bg-white-100 border-1 border-yellow-300 rounded-xl">
                            <span class="text-gray-700 font-medium">{{ $satuan->nama_layanan }}</span>
                            <span class="text-xl font-bold text-orange-600">Rp
                                {{ number_format($satuan->harga, 0, ',', '.') }}/pcs</span>
                        </div>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="bg-white rounded-3xl p-12 shadow-2xl border border-gray-100">
                <form id="trackingForm" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nota" name="nota" placeholder="Contoh: ORD-20241205-001"
                ...
                <div class="mt-8 p-6 bg-purple-50 rounded-2xl border-2 border-purple-100">
                    <div class="flex items-start gap-4">
                        {{-- <div
                            class="w-10 h-10 gradient-primary rounded-xl flex items-center justify-center flex-shrink-0">
                            --}}
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="text-right">
                                <span id="resultStatusBadge"
                                    class="px-4 py-2 rounded-full text-sm font-bold uppercase"></span>
                            </div>
                        </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white border border-gray-200 rounded-2xl p-6">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <span hidden id="resultJenisLayanan"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-3xl p-10 hover-scale shadow-lg">
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Menggunakan deterjen berkualitas tinggi dan proses pencucian standar premium untuk hasil
                        maksimal.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-3xl p-10 hover-scale shadow-lg">
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Setiap item dicatat dan ditimbang dengan jelas. Jika terjadi kehilangan, kami siap bertanggung
                        jawab.
                    </p>
                </div>
    ...
    <section id="testimoni" class="py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div
                    class="bg-gradient-to-br from-purple-50 to-blue-50 rounded-3xl p-8 hover-scale border border-purple-100">
                    ...
                    <p class="text-gray-700 mb-6 leading-relaxed italic">
                        "Pelayanan sangat cepat dan hasilnya bersih wangi! Sistem tracking-nya juga memudahkan untuk
                        pantau status cucian. Recommended banget!"
                    </p>
                    <div class="flex items-center gap-3">
                        <div
                            class="w-12 h-12 gradient-primary rounded-full flex items-center justify-center text-white font-bold text-lg">
                            AS
                        </div>
                        <div>
                ...
                <div
                    class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl p-8 hover-scale border border-green-100">
                    <div class="flex items-center gap-2 mb-4">
                        <svg class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                            <path
                                d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z">
                    ...
                    <p class="text-gray-700 mb-6 leading-relaxed italic">
                        "Setiap kali bawa cucian ke sini, hasilnya selalu memuaskan. Pakaian disetrika rapi, lipatannya
                        bersih, dan wanginya tahan lama. Tempat terbaik buat langganan!"
                    </p>
                    <div class="flex items-center gap-3">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-green-400 to-emerald-600 rounded-full flex items-center justify-center text-white font-bold text-lg">
                            BP
                        </div>
                        <div>
                ...
                <div
                    class="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-3xl p-8 hover-scale border border-orange-100">
                    <div class="flex items-center gap-2 mb-4">
                        <svg class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                            <path
                                d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z">
                    ...
                    <p class="text-gray-700 mb-6 leading-relaxed italic">
                        "Layanan cuci satuan untuk jas kerja saya hasilnya sempurna! Rapi dan wangi. Pasti jadi
                        langganan saya terus."
                    </p>
                    <div class="flex items-center gap-3">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-orange-400 to-yellow-600 rounded-full flex items-center justify-center text-white font-bold text-lg">
                            CH
                        </div>
                        <div>
            ...
            <div class="grid md:grid-cols-3 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="#layanan"
                                class="hover:text-purple-400 transition">{{ $layananList->nama_layanan }}</a></li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start gap-3">
                            <svg class="w-5 h-5 text-purple-400 flex-shrink-0 mt-1" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z">
                                </path>
    ...
    function displayTrackingResult(data) {
        ...
        document.getElementById('resultStatusBadge').className =
            `${config.badgeClass} px-4 py-2 rounded-full text-sm font-bold uppercase`;
        ...
        jenisSpan.className =
            `${order.jenis === 'kiloan' ? 'bg-blue-100 text-blue-700' : 'bg-purple-100 text-purple-700'} px-3 py-1 rounded-full text-xs font-bold uppercase`;
