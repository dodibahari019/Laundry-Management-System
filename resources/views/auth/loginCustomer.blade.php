...
<body class="bg-gray-50 min-h-screen py-20 flex items-center justify-center relative">
        ...
        <div class="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div class="fade-in">
                <div class="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-100">
                    ...
                    <form id="formLoginCustomer" class="space-y-6">
                        @csrf
                        <!-- Username Input -->
                        <div>
                        ...
                        <div class="flex justify-end">
                            <a href="/forgot-password" class="text-sm font-semibold text-purple-600 hover:text-purple-800 transition">
                                Lupa Password?
                            </a>
                        </div>
                        ...
                        <button
                            ...
                            class="google-btn w-full bg-white border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-50 transition shadow-lg flex items-center justify-center gap-3"
                        >
                        ...
                        <div class="text-center mt-6">
                            <p class="text-gray-600">
                                Belum punya akun?
                                <a href="/customer-register" class="font-bold text-purple-600 hover:text-purple-800 transition">
                                    Daftar Sekarang
                                </a>
                            </p>
                        </div>
                        ...
                        <a
                            href="/login"
                            class="w-full bg-white-100 border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-200 transition shadow-lg flex items-center justify-center gap-3"
                        >
    ...
    <script>
        ...
        $('#formLoginCustomer').on('submit', function(e) {
            e.preventDefault();
                ...
                success: function(response) {
                    ...
                    if (response.email_not_verified) {
                        Swal.fire({
                            ...
                            confirmButtonText: 'Kirim Ulang Verifikasi',
                            cancelButtonText: 'Tutup',
                            confirmButtonColor: '#6D28D9'
                        }).then((result) => {
                            if (result.isConfirmed) {
                                resendVerification(response.email);
                            }
                        });
                        return;
                    }
        ...
        function resendVerification(email) {
            $.post('/email/resend-verification', { email: email })
                .done(() => {
                    Swal.fire({
                        icon: 'success',
                        title: 'Berhasil',
