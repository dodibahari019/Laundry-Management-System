    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 20%;" class="text-center">Tanggal Transaksi</th>
                <th style="width: 20%;" class="text-right">Jumlah Transaksi</th>
                <th style="width: 27%;" class="text-right">Total Pendapatan</th>
                <th style="width: 28%;" class="text-right">Rata-Rata per Transaksi</th>
            </tr>
        </thead>
        <tbody>
            @php
            ...
            <tr>
                ...
                <td class="text-center">{{ \Carbon\Carbon::parse($item->tanggal_transaksi)->format('d F Y') }}</td>
                ...
                <td class="text-right font-bold">Rp {{ number_format($item->rata_rata_per_transaksi, 0, ',', '.') }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
